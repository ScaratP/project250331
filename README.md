...
這是一個專為學生設計的 Android 課程管理應用程式，提供課表管理、請假申請、通知提醒、筆記功能和學餐轉盤。本專案是對原始 project250311 的改進版本，使用了更現代的架構與功能。

## 📱 概述 (Overview)

本應用程式旨在幫助學生有效管理學習生活，提供直觀的課表、便捷的請假系統、智能通知提醒、功能完善的筆記工具和趣味學餐選擇轉盤。採用現代化的UI和架構設計，確保操作流暢且易於使用。
